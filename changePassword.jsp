	...
	color: red;
      ...
      <!-- start page title section -->
        ...
        <section class="wow fadeIn big-section bg-light-gray" id="section-down">
         <form id="resetPaswrdForm"  method="post"  name="changePaswrdForm" validate ng-submit="resetPassword()" ng-cloak>
            <div class="container">
                    ...
                    <div class="col-md-6 wow fadeIn center-col">
                        <div class="padding-fifteen-all bg-white border-radius-6 md-padding-seven-all xs-padding-30px-all height-100">
                                ...
                                <div>
             					  ...
             					  <!--  <input required  type="password" ng-pattern="/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)[A-Za-z\d]{4,}$/" ng-model="userLogin.confirmPassword" name="newPassword" id="newPasswordId" placeholder="New Password" class="border-radius-4 input-bg medium-input" > 
             					   <span  style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.newPassword.$error.required">Password is Required</span><br/>
             					   <span  style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.newPassword.$error.pattern">
  										 Combination of small,capital,numeric and min 8 char.
  									</span>  -->
  									
  								
                                    <input required type="password"   ng-model="userLogin.oldPassword" name="oldPassword" id="oldPasswordId" placeholder=" Old Password" class="border-radius-4 input-bg medium-input" ></input>
                                   <span  ng-cloak style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.oldPassword.$error.required">Old Password is Required</span><br/>
                                  <span toggle="#oldPasswordId" class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                  ...
                                  <br/>
                                   ...
                                   <span  style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.newPassword.$error.required">New Password is Required</span><br/>
                               ...
                               <!--   <span  style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.newPassword.$error.pattern">
                                  ...
                                  <br/>
                                   ...
                                   <span  style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.confirmPassword.$error.required">Confirm Password is Required</span><br/>
                                    <span  style='color:red' ng-show="submitted && userLogin.newPassword != userLogin.confirmPassword">Password mismatch</span>
                                  <span style='color:red' class="help-inline" ng-show="submitted && changePaswrdForm.confirmPassword.$error.ngcompare" class="help-block">Password's don't match</span>
